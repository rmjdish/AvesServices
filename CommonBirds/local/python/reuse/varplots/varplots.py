...
#from plotcolumn import PlotColumn
...
class VarPlots():
    ...
    def __init__(self):
        ...
        cd.info_log(f"Constructor: Start of {logfile}")
    ...
    def metaAnalysis(self):
        ...
        pullobj = DataPull() # Class that has data pulling methods
    ...
    def do1col(self, row):
        ...
        @param row - Named tuple from icol corresponding to a column from self.dataframe
        """
    ...
    def excludeMissing(self, row):
        ...
        if tpe in NUMS:
            ...
            if meta.empty:
                ...
                # Only numbers left all the NaNs and Strings gone
